...
class TestGithubOrgClient(unittest.TestCase):
    """ Github Org Client class that inherits from unittest.TestCase """
    ...
    def test_public_repos(self, mock_json):
        ...
        Test that mocked property and the mocked get_json were called once.
        """
    ...
    def test_has_license(self, repo, license_key, expected):
        """ unit-test for the GithubOrgClient.has_license """
